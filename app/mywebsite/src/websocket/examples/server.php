...
$server = new \BloatlessModified\WebSocket\Server('127.0.0.1', 8000, '/tmp/phpwss.sock');
...
$server->registerApplication('status', \BloatlessModified\WebSocket\Application\StatusApplication::getInstance());
$server->registerApplication('chat', \BloatlessModified\WebSocket\Examples\Application\Chat::getInstance());
